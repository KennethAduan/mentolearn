        ...
        <div>
          ...
          <div className="content text-center about-contents">
            <div className="about mt-10 ">
              <h1 className="text-5xl font-bold mb-2">About MentoLearn</h1>
              <p>
            ...
            <div className="mission mt-12">
              ...
              <p>
                Mento Learn is a community-based mission to help you to learn
            ...
            <div className="WhoAreWe mt-12 mb-80">
              ...
              <p>
                Mento Learn began in co-founder John Kenneth Aduan living room
                in 2022
                <br />
                and was official launched on January 15, 2023.
                <br />
                <br />
                Today, MentoLearn leads a diversified business with revenues
                from <br />
                membership subscriptions, advertising sales and recruitment{" "}
                <br />
                solutions under the leadership of Kenneth Aduan Lorem ipsum
